...
```{r}
lm(log(twitch$follower_gain_count)~log(twitch$follower_count))
plot(x = log(twitch$follower_count), y = log(twitch$follower_gain_count))
abline(lm(log(twitch$follower_gain_count)~log(twitch$follower_count)))
```
